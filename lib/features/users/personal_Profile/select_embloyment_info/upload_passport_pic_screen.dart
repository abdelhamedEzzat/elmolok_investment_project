...
class UploadPassportPicScreen extends StatefulWidget {
  const UploadPassportPicScreen({super.key});

  @override
  State<UploadPassportPicScreen> createState() =>
      _SelectEmploymentScreensState();
}

class _SelectEmploymentScreensState extends State<UploadPassportPicScreen> {
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: SelcetEmploymentScreenItems(
          buttonTextakePhoto: StringsManger.pleaseUploadPassportPic,
          ...
          titleForEmploymentScreen:
              StringsManger.readyToInvestAndAccsessOurReport,
          subTitle: StringsManger.pleaseUploadYourPassport,
          hitText: StringsManger.pleaseUploadPassportPic,
            ...
            children: [
              Container(
                ...
                child: Lottie.network(
                  "https://lottie.host/c830b75f-cde4-4b8d-911e-ae3e8d7dce25/e7nps0N75U.json",
                  fit: BoxFit.fill,
                ),
              ),
              SizedBox(
